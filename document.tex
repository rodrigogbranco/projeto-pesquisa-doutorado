...
Obtenção de Créditos em disciplinas & X & X &  &  &  &  &  &  \\ \hline
Revisão da Literatura &  & X & X &  &  &  &  &  \\ \hline
Planejamento e modelagem dos algoritmos &  &  & X & X &  &  &  &  \\ \hline
Implementação dos algoritmos &  &  &  & X & X & X &  &  \\ \hline
Testes dos algoritmos &  &  &  &  & X & X &  &  \\ \hline
Verificação de resultados &  &  &  &  &  & X & X &  \\ \hline
Comparação com outras soluções já desenvolvidas &  &  &  &  &  & X & X &  \\ \hline
Ajustes e otimização dos algoritmos desenvolvidos &  &  &  &  &  &  & X &  \\ \hline
Análise e interpretação dos resultados &  &  &  &  &  &  & X &  \\ \hline
Publicação de artigos &  &  &  &  &  &  & X & X \\ \hline
Escrita da tese &  &  &  &  & X & X & X & X \\ \hline
\end{tabular}%
}
\end{center}
